...
namespace Puzzle.MicroHeap
{
    ...
    public sealed class PriorityQueue<T> : ICollection<T>, ICloneable
    {
        ...
        /// <summary>
        /// This is the version of the <see cref="PriorityQueue{T}"/> class.
        /// </summary>
        public static readonly Version Version = new Version(1, 0, 0, 0);

        /// <summary>
        /// This is the default size of a new <see cref="PriorityQueue{T}"/>, unless specified
        /// with one of the constructor overloads, or given an initial collection
        /// to populate the <see cref="PriorityQueue{T}"/> with.
        /// </summary>
        ...
        /// </overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="PriorityQueue{T}"/> class using the specified capacity, comparer and reverse
        /// settings.
        /// </summary>
        /// <param name="capacity">
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PriorityQueue{T}"/> class using the specified capacity.
        /// </summary>
        /// <param name="capacity">
        /// The initial capacity to construct the heap with. 10 will be used if the value is less than 10.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PriorityQueue{T}"/> class using the default capacity.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PriorityQueue{T}"/> class from the items in the collection.
        /// settings.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PriorityQueue{T}"/> class from the specified items.
        /// settings.
        /// </summary>
        /// <param name="values">
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PriorityQueue{T}"/> class with
        ...
        /// <summary>
        /// Adds the elements of the specified collection to this <see cref="PriorityQueue{T}"/>.
        /// </summary>
        /// <param name="collection">
        /// The collection whose elements should be added to this <see cref="PriorityQueue{T}"/>.
        /// </param>
        /// <exception cref="ArgumentNullException">
        /// <para><paramref name="collection"/> is <c>null</c>.</para>
        /// </exception>
        ...
        /// <summary>
        /// Adds an item to this <see cref="PriorityQueue{T}"/>
        /// </summary>
        /// <param name="item">
        /// The item to add to this <see cref="PriorityQueue{T}"/>.
        /// </param>
        ...
        /// that are currently enumerating over this <see cref="PriorityQueue{T}"/>.
        /// </summary>
        ...
        /// (see <see cref="PriorityQueue{T}"/>) is satisfied.
        /// </summary>
        /// <param name="value">
        ...
        /// <summary>
        /// Removes all items from this <see cref="PriorityQueue{T}"/>.
        /// </summary>
        public void Clear()
        {
            for (int index = 0; index < _Count; index++)
        ...
        /// <summary>
        /// Determines whether this <see cref="PriorityQueue{T}"/> contains a specific value.
        /// </summary>
        /// <returns>
        /// <c>true</c> if <paramref name="item"/> is found in this <see cref="PriorityQueue{T}"/>;
        /// otherwise, <c>false</c>.
        /// </returns>
        /// <param name="item">
        /// The item to locate in this <see cref="PriorityQueue{T}"/>.
        /// </param>
        ...
        /// <summary>
        /// Copies the elements of this <see cref="PriorityQueue{T}"/> to an <see cref="Array"/>,
        /// starting at a particular <see cref="Array"/> index.
        /// </summary>
        /// <param name="array">
        /// The one-dimensional <see cref="Array"/> that is the destination of the elements copied
        /// from this <see cref="PriorityQueue{T}"/>. The <see cref="Array"/> must have zero-based indexing.
        /// </param>
        ...
        /// <para>The number of elements in the source <see cref="PriorityQueue{T}"/> is greater than the available space from <paramref name="arrayIndex"/> to the end of the destination <paramref name="array"/>.</para>
        /// <para>- or -</para>
        ...
        /// <summary>
        /// Removes the first occurrence of a specific item from this <see cref="PriorityQueue{T}"/>.
        /// </summary>
        /// <returns>
        /// <c>true</c> if <paramref name="item"/> was successfully removed from this <see cref="PriorityQueue{T}"/>;
        /// otherwise, <c>false</c>.
        /// </returns>
        /// <param name="item">
        /// The item to remove from this <see cref="PriorityQueue{T}"/>.
        /// </param>
        ...
        /// <summary>
        /// Gets the number of elements contained in this <see cref="PriorityQueue{T}"/>.
        /// </summary>
        /// <returns>
        /// The number of elements contained in this <see cref="PriorityQueue{T}"/>.
        /// </returns>
        public int Count
        {
            get
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="PriorityQueue{T}"/> is ordering
        ...
        /// satisfies the heap criteria. See <see cref="PriorityQueue{T}"/> for more information about this.</para>
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="PriorityQueue{T}"/> is read-only.
        /// </summary>
        /// <returns>
        /// Always <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Creates a new object that is a copy of this <see cref="PriorityQueue{T}"/>.
        /// </summary>
        /// <returns>
        /// A new object that is a copy of this <see cref="PriorityQueue{T}"/>.
        /// </returns>
